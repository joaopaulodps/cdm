...
function AdmintitleTitle(){
    ...
    useEffect(()=> {
        api.get(`api/admin/teams-titles/${team_id}/index`, {
            headers : {
    ...
    async function TitleDelete(id){
        ...
        const response = await api.post(`/api/admin/teams-titles/${id}/delete`, data, {
            headers : {
                'Content-Type': 'application/json',
                'Accept': 'application/json',
                'Authorization': 'Bearer ' + token
            ...
            <div className="container">
                <div className="listagem">
                    <div className="row justify-content-center">
                                            ...
                                            (   
                                                <tr key={"index" + i}>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div>
                                                            <Link className="btn-edit" to={`/admin/paises/${country_id}/times/${team_id}/titulos/${title.id}/editar`}><FontAwesomeIcon icon={faPen}/></Link>
                                                        </div>
                                                    </td>
                                                </tr>
                                            )
                        ...
                        <Link to={`/admin/paises/${country_id}/times/${team_id}/titulos/criar`}><div  className="btn-new"><p><FontAwesomeIcon icon={faPlus} />Cadastrar Título</p></div></Link> 
                        </div>           
                    </div>
                </div>
            </div>
...
export default AdmintitleTitle;