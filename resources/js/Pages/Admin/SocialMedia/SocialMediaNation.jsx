...
function NationSocialMedia(){
    ...
    useEffect(()=> {
        api.get(`api/admin/social_media/${nation_id}/indexNation`, {
            headers : {
            ...
            <div className="container">
                <div className="listagem">
                    <div className="row justify-content-center">
                                            ...
                                            (   
                                                <tr key={"index" + i}>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div>
                                                            <Link className="btn-edit" to={`/admin/paises/${country_id}/selecao/${nation_id}/redes-sociais/${media.id}/editar`}><FontAwesomeIcon icon={faPen}/></Link>
                                                        </div>
                                                    </td>
                                                </tr>
                                            )
                        ...
                        <Link to={`/admin/paises/${country_id}/selecao/${nation_id}/redes-sociais/criar`}><div  className="btn-new"><p><FontAwesomeIcon icon={faPlus} />Cadastrar Redes</p></div></Link> 
                        </div>           
                    </div>
                </div>
            </div>
...
export default NationSocialMedia;