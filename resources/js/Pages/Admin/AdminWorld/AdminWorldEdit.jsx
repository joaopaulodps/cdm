...
function AdminWorldEdit() {
    ...
    useEffect(()=> {
        api.get(`api/admin/world/${id}/edit`, {
            headers : {
            ...
            if(response.data.status === 'success'){
                ...
                setHeadOffice(response.data[0].head_office)
    ...
    async function onSubmit(e){
        ...
        if(!name || !details){
            ...
            const response = await api.post(`/api/admin/world/${id}/update`, data, {
                headers : {
                    'Content-Type': 'application/json',
                    'Accept': 'application/json',
                    'Authorization': 'Bearer ' + token
