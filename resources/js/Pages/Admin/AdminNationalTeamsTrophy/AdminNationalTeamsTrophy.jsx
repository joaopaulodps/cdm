...
function NationsTrophies(){
    ...
    async function CompetitionDelete(id){
        ...
        const response = await api.post(`/api/admin/nations-competitions/${id}/delete`, data, {
            headers : {
                'Content-Type': 'application/json',
                'Accept': 'application/json',
                'Authorization': 'Bearer ' + token
    ...
    return (
        <>
            <HeaderAdmin titulo={'Competições de Seleções'}/>
            <div className="container">
                <div className="listagem">
                    <div className="row justify-content-center">
                                            ...
                                            (   
                                                <tr key={"index" + i}>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div>
                                                            <Link className="btn-edit" to={`/admin/competicoes-selecoes/${competition.id}/editar`}><FontAwesomeIcon icon={faPen}/></Link>
                                                        </div>
                                                    </td>
                                                </tr>
                                            )
                        ...
                        <Link to={`/admin/competicoes-selecoes/criar`}><div  className="btn-new"><p><FontAwesomeIcon icon={faPlus} />Cadastrar Competição</p></div></Link> 
                        </div>           
                    </div>
                </div>
            </div>
...
export default NationsTrophies;