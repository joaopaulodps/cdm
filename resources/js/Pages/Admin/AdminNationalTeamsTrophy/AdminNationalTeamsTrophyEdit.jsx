...
function NationsTrophyEdit(){
    ...
    useEffect(()=> {
        api.get(`api/admin/nations-competitions/${id}/edit`, {
            headers : {
            ...
            if(response.data.status === 'success'){
                ...
                setCompetition(response.data[0].competition)
    ...
    async function onSubmit(e){
        ...
        const response = await api.post(`/api/admin/nations-competitions/${id}/update`, data, {
            headers : {
                'Content-Type': 'application/json',
                'Accept': 'application/json',
                'Authorization': 'Bearer ' + token
        ...
        if (response.data.status === 'success') {
            ...
            history.push(`/admin/competicoes-selecoes`)
        } else {
            alert(response.data.msg);
        }
    }
    ...
    return (
        <>
            <HeaderAdmin titulo={'Editar Competição'} />
...
export default NationsTrophyEdit;