...
function TeamEdit(){
    ...
    useEffect(()=> {
        api.get(`api/admin/team/${id}/edit`, {
            headers : {
            ...
            if(response.data.status === 'success'){
                ...
                setRegional(response.data[0].regional_federation)
    ...
    async function onSubmit(e){
        ...
        const response = await api.post(`api/admin/team/${id}/update`, data, {
            headers : {
                'Content-Type': 'application/json',
                'Accept': 'application/json',
                'Authorization': 'Bearer ' + token
                                ...
                                <div className="card-body">
                                    <form onSubmit={onSubmit}>
                                        ...
                                        <div className="form-group row">
                                            ...
                                            <div className="col-12col-xs-12 col-md-12">
                                                <input id="regional_federation" type="text" className="form-control"  name="regional_federation" value={regional?regional:''} onChange={e =>setRegional(e.target.value)} />
                                            </div>
                                        </div>
