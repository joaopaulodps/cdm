...
function AdminNationTitleEdit(){
    ...
    const {country_id, nation_id, title_id} = useParams();
    ...
    useEffect(()=> {
        api.get(`api/admin/nations-titles/${title_id}/edit`, {
            headers : {
                'Content-Type': 'application/json',
                'Accept': 'application/json',
                'Authorization' : 'Bearer '  + token
    ...
    async function onSubmit(e){
        ...
        const response = await api.post(`api/admin/nations-titles/${title_id}/update`, data, {
            headers : {
                'Content-Type': 'application/json',
                'Accept': 'application/json',
                'Authorization': 'Bearer ' + token
...
export default AdminNationTitleEdit;