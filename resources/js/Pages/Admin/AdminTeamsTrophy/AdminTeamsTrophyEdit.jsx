...
function TeamTrophyEdit(){
    ...
    useEffect(()=> {
        api.get(`api/admin/teams-competitions/${id}/edit`, {
            headers : {
    ...
    async function onSubmit(e){
        ...
        const response = await api.post(`/api/admin/teams-competitions/${id}/update`, data, {
            headers : {
                'Content-Type': 'application/json',
                'Accept': 'application/json',
                'Authorization': 'Bearer ' + token
