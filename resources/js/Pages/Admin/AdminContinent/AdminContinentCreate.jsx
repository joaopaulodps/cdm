...
function AdminContinentCreate() {
    ...
    async function onSubmit(e){
        e.preventDefault();
        console.log(name, foundation, continent, details)
        ...
        const response = await api.post('/api/admin/continent/store', data, {
            headers : {
                'Content-Type': 'application/json',
                'Accept': 'application/json',
                'Authorization': 'Bearer ' + token
...
export default AdminContinentCreate;